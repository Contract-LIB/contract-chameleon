...
public record Abstraction(
    SortDec identifier,
    DatatypeDec datatypeDec) implements JoinableCommand<Abstraction> {
  ...
  public <R> R perform(
    ...
    return decAbstraction.apply(this);
  }

  @Override
  public <R> Function<JoinedCommand<Abstraction>, R> select(
      Function<JoinedCommand<Abstraction>, R> decAbstractions,
      Function<JoinedCommand<Datatype>, R> decDatatape,
      Function<JoinedCommand<FunctionDec>, R> decFunctionsRec) {
    return decAbstractions;
  }
}
